...
(function () {
    ...
    async function _runAgentTask(userRequest) {
        ...
        for (var step = 0; step < MAX_STEPS; step++) {
            ...
            // 任务完成
            if (action.type === 'done') {
                var doneMsg = action.think || '任务完成';
                _showReply(userRequest, doneMsg);
                return;
            }
            ...
            if (result === null) {
                var doneMsg2 = action.think || '任务完成';
                _showReply(userRequest, doneMsg2);
                return;
            }
        ...
        _showReply(userRequest, '已执行' + MAX_STEPS + '步操作，你可以告诉我继续做什么。');
    }
