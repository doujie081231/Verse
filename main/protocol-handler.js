// ============================================================================
// versepc:// 协议处理器 - 协议路由 + API/SSE 分发 + 静态文件 + 路径白名单
// ============================================================================
// 职责：
...
//
// 依赖注入：
// - setupProtocolHandler({ appRoot, reloadServerModule, getServerCrashCount, SERVER_MAX_CRASHES })
//   * appRoot             项目根目录（main.js 所目录），替代模块内的 __dirname
